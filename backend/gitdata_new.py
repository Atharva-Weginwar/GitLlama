...
if __name__ == "__main__":
    ...
    output_file = "repository_data_new.json"
    
    # Process the repository with commit limit (adjust commit limit here if needed)
    process_repository(repo_url, output_file, commit_limit_per_branch=50)
