...
#         logger.error("OpenAI API key is invalid or not set")
#         return "Error: OpenAI API key is invalid or not set. Please check your API key."
#     except openai.APIError as e:
#         logger.error(f"OpenAI API returned an API Error: {str(e)}")
#         return f"Error: OpenAI API returned an error: {str(e)}"
...
#         logger.error(f"Unexpected error during commit summarization: {str(e)}")
